...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd: BasicPointCloud, scaling, spatial_lr_scale: float, drop_rate=1.0):
        points = pcd.points
        colors = pcd.colors
        ...
        fused_point_cloud = fused_point_cloud[vert_id_to_keep]
        fused_color = fused_color[vert_id_to_keep]
